...
const CITY_CENTERS = [
  ...
  { name: '天津市', latitude: 39.3434, longitude: 117.3616 },
  { name: '上海市', latitude: 31.2304, longitude: 121.4737 },
  { name: '重庆市', latitude: 29.563, longitude: 106.5516 },
  { name: '杭州市', latitude: 30.2741, longitude: 120.1551 },
  { name: '东阳市', latitude: 29.2896, longitude: 120.2418 },
  { name: '金华市', latitude: 29.0791, longitude: 119.6474 },
  { name: '宁波市', latitude: 29.8683, longitude: 121.544 },
  { name: '温州市', latitude: 27.9938, longitude: 120.6994 },
  { name: '湖州市', latitude: 30.8943, longitude: 120.0868 },
  { name: '嘉兴市', latitude: 30.7461, longitude: 120.7555 },
  { name: '绍兴市', latitude: 30.0303, longitude: 120.5802 },
  { name: '台州市', latitude: 28.6561, longitude: 121.4208 },
  { name: '衢州市', latitude: 28.9701, longitude: 118.8593 },
  { name: '丽水市', latitude: 28.4676, longitude: 119.9229 },
  { name: '舟山市', latitude: 29.9853, longitude: 122.2072 },
  { name: '苏州市', latitude: 31.2989, longitude: 120.5853 },
  { name: '南京市', latitude: 32.0603, longitude: 118.7969 },
  { name: '无锡市', latitude: 31.4912, longitude: 120.3119 },
  { name: '常州市', latitude: 31.8107, longitude: 119.9741 },
  { name: '南通市', latitude: 31.9802, longitude: 120.8943 },
  ...
  { name: '西安市', latitude: 34.3416, longitude: 108.9398 },
  { name: '郑州市', latitude: 34.7466, longitude: 113.6254 },
  { name: '长沙市', latitude: 28.2282, longitude: 112.9388 },
  { name: '合肥市', latitude: 31.8206, longitude: 117.2272 },
  { name: '福州市', latitude: 26.0745, longitude: 119.2965 },
  { name: '厦门市', latitude: 24.4798, longitude: 118.0894 },
  { name: '南昌市', latitude: 28.6829, longitude: 115.8582 },
  { name: '济南市', latitude: 36.6512, longitude: 117.1201 },
  { name: '青岛市', latitude: 36.0671, longitude: 120.3826 }
];

const CITY_GROUPS = [
  { province: '直辖市', cities: ['北京市', '天津市', '上海市', '重庆市'] },
  ...
  { province: '浙江省', cities: ['杭州市', '宁波市', '温州市', '嘉兴市', '湖州市', '绍兴市', '金华市', '衢州市', '舟山市', '台州市', '丽水市', '东阳市', '义乌市'] },
  ...
  { province: '香港澳门台湾', cities: ['香港特别行政区', '澳门特别行政区', '台北市', '新北市', '桃园市', '台中市', '台南市', '高雄市', '基隆市', '新竹市', '嘉义市'] }
];
