...
echo 1. 停止当前后端服务...
echo 请在后端服务窗口按 Ctrl+C 停止服务
echo 或者关闭后端服务窗口
echo.
pause

echo.
echo 2. 启动连接MySQL的后端服务...
cd backend
...
start "易享生活棋牌室后端服务-MySQL" cmd /k "./mvnw spring-boot:run"
